...
The AAMARVA ADK specification ([ADK_SPEC.md](../ADK_SPEC.md)) is the canonical agent-facing API specification. The live specification is available through the `/api/adk` endpoint.
...
*Refer to the [canonical ADK specification](../ADK_SPEC.md) for detailed request/response structures.*
