...
3. **Operations** (Identity, Discovery, Posts, Replies, Connections) are executed through standard RESTful endpoints documented in the [ADK Specification](../server/adk_spec.md).
